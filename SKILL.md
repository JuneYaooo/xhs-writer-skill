...
基于 gpt-image2-ppt-skills 真实案例（6次迭代，最终 7 张卡片）：

**5大核心原则**：
1. **真实素材 > AI 生图**：项目截图、对比图比纯 AI 生成更有说服力
2. **聚焦核心卖点**：优先级 = 稀缺性(1-5) × 实用性(1-5) × 可感知(1-5)
3. **素人感 > 精美设计**：纯色背景 + 大 emoji + 口语化 > 品牌宣传
4. **痛点 > 功能堆砌**：说"能解决什么问题"，不说"有多少功能"
5. **快速迭代 > 一次完美**：V1(60分) → 用户反馈 → V2(70分) → ...

**详细方法论**：见 `references/xiaohongshu-viral-methodology.md`
**真实案例**：见 `references/case-gpt-image2-ppt.md`
...
### Step 0.5 — 卖点分析（推广类内容必做）

**触发条件**：用户说"推广这个项目"、"做爆款笔记"、"帮我宣传"

**执行**：
1. 列出所有功能/特性
2. 用 AskUserQuestion 让用户打分（每个功能）：
   - 稀缺性（1-5）：其他工具有吗？
   - 实用性（1-5）：能解决多大问题？
   - 可感知（1-5）：用户能直接看到效果吗？
3. 计算得分 = 稀缺性 × 实用性 × 可感知
4. 排序，选择 Top 1-2 作为核心卖点
...
**标题生成（5种公式）**：
1. **痛点+解决方案**：`{具体痛点}？{解决方案}`
   - 例："凌晨3点还在改PPT？这个工具能一键复刻公司模板"
2. **提问式**：`有没有那种{功能描述}的{产品类型}？`
   - 例："有没有那种能复刻公司PPT模板的AI工具？"
3. **发现式**：`我发现了个宝藏！{核心价值}`
   - 例："我发现了个宝藏！AI能完全复刻公司PPT模板"
4. **热点词**：`{热点词}爆火后，我用它做了{场景}`
   - 例："gpt-image-2爆火后，我用它做了个PPT神器"
5. **身份共鸣**：`{身份标签}必备！{核心功能}`
   - 例："打工人必备！一键复刻老板的PPT模板"
...
### 真实案例
- **`references/case-gpt-image2-ppt.md`**：gpt-image2-ppt-skills 推广案例
  - 6次迭代过程（V1→V6）
  - 核心经验总结（5大洞察）
  - 可复用流程
  - 时间成本：2-3小时
...
**更新时间**：2026-04-25
**基于案例**：gpt-image2-ppt-skills（6次迭代，7张卡片，预期 5k-50k 赞）
