...
**详细方法论**：见 `references/xiaohongshu-viral-methodology.md`（通用框架）
**案例参考**：见 `references/case-gpt-image2-ppt.md`（具体实施示例）
...
### 案例参考（具体实施）
- **`references/case-gpt-image2-ppt.md`**：开源项目推广案例
  - 完整迭代过程（V1→V6，6次迭代）
  - 核心经验总结（5大洞察）
  - 可复用流程
  - 时间成本：2-3小时
  - API 成本：$2-5
  - 最终效果：7张卡片，预期 5k-50k 赞
  - **注意**：这是具体案例，不是通用模板。使用时需根据自己的项目调整。
...
**更新时间**：2026-04-25
**方法论来源**：基于真实案例沉淀的通用框架（详见 references/）
